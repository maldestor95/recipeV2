...
export class Recipe {
    ...
    constructor(markdownRecipe: string) {
        const { data, err } = this.convertMarkdownRecipe(markdownRecipe)
    ...
    private convertMarkdownRecipe = function (mdData: string): { err: string | null, data: { yml: string, md: string } } {
